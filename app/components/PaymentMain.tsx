...
const PaymentMain: React.FC<PaymentOptionsProps> = ({ amount, pricePerPlayer, onBack, onNext }) => {
    ...
    return (
        <div className="mt-[80px] p-4rounded-lg mx-auto w-[760px] pb-20">
            <h2 className="text-[45px] font-bold text-black leading-[1.1] w-full">
            ...
            <div className="flex justify-start items-baseline mb-[40px] text-2xl font-semibold mt-[40px]">
                <div className="flex items-baseline">
                    <span className="text-[36px] font-regular text-black">5600 ₽</span>
                    <span className="ml-3 text-[24px] font-normal text-gray-500">к оплате</span>
                </div>
                <div className="flex items-baseline ml-20">
                    <span className="text-[36px] font-regular text-black">700 ₽</span>
